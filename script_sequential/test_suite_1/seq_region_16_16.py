...
OUTPUT_REGION_FOLDER = "region_16_16" + "_seq"
...
print("SA parameters: MAX_ITERATIONS {0}; MAX_TEMP {1}; NUMBER_OF_DISTRICTS {2}; REGION_ID {3}"
              .format(MAX_ITERATIONS, MAX_TEMP, NUMBER_OF_DISTRICTS, REGION_ID))
